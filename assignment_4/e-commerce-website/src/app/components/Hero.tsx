...
export default function Hero() {
  return (
    <section className="w-full bg-[#F0F0F0] py-8 px-4 md:py-16">
      {/* Main Content */}
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:gap-0 lg:grid-cols-2 gap-8">
        {/* Text Section */}
        <div className="space-y-4 md:space-y-6">
          ...
          <button className="mt-4 w-full md:w-[35%] md:mt-6 px-6 py-3 rounded-full bg-black text-white hover:bg-gray-800">
            Shop Now
          </button>
