      ...
      BROWSE BY DRESS STYLE
        ...
        <div className=" grid grid-cols-3 gap-4">
          <div className="absolute top-[192px] left-[64px] gap-0 rounded-2xl">
             <Image src="/img10.png" alt="" height={289} width={407} className="rounded-[20px]"/>
           <h3 className="absolute h-[49px] top-0 mb-3 left-[36px] gap-0 font-satoshi text-[36px] font-bold leading-[48.6px] text-left">Casual</h3>
          </div>
          <div className="w-[684px] h-[289px] absolute top-[192px] left-[491px]">
          <Image src="/img11.png" alt="" height={289} width={684} className="rounded-[20px]"/>
          <h3 className="absolute h-[49px] top-0 mb-3 left-[36px] gap-0 font-satoshi text-[36px] font-bold leading-[48.6px] text-left">Formal</h3>
         </div>
          <div className="w-[684px] h-[289px] absolute top-[501px] left-[64px]">
          <Image src="/img12.png" alt="" height={289} width={684} className="rounded-[20px]"/>
          <h3 className="absolute h-[49px] top-0 left-[36px] gap-0 font-satoshi text-[36px] font-bold leading-[48.6px] text-left">Party</h3>
         </div>
         <div className="absolute top-[501px] left-[768px] gap-0 rounded-2xl">
             <Image src="/img13.png" alt="" height={289} width={407} className="rounded-[20px]"/>
           <h3 className="absolute h-[49px] top-0 mb-3 left-[36px] gap-0 font-satoshi text-[36px] font-bold leading-[48.6px] text-left">Gym</h3>
          </div>
