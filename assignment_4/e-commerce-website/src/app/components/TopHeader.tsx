...
//   return (  
//     // sm:px-4 xl:px-0 overflow-hidden
//     <div className="bg-black text-white w-full text-center py-2 px-2 ">
...
//         </p>
//         <button
//           className="flex items-center justify-center ml-4 right-0 top-1/2 "
//           type="button"
